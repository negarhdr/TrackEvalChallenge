...
class KittiRunner(BaseRunner):
    def __init__(self):
        ...
        default_dataset_config = datasets.Kitti2DBox.get_default_dataset_config()
...
if __name__ == '__main__':
    runner = KittiRunner()
    runner.run(
        dataset_cls = datasets.Kitti2DBox,
        metric_classes = [metrics.HOTA, metrics.CLEAR, metrics.Identity, metrics.MaxSim]
    )